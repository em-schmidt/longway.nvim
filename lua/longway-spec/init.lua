...
M["make-epic"] = function(overrides)
  return vim.tbl_deep_extend("force", {id = 99999, name = "Test Epic", description = "This is the epic description.", state = "in progress", app_url = "https://app.shortcut.com/test/epic/99999", created_at = "2026-01-01T00:00:00Z", updated_at = "2026-01-15T12:00:00Z", planned_start_date = "2026-01-01", deadline = "2026-03-01", stats = {num_stories = 10, num_stories_started = 3, num_stories_done = 5, num_stories_unstarted = 2, num_points = 20, num_points_done = 10}}, (overrides or {}))
end
