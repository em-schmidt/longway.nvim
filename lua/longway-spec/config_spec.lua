...
local function _1_()
  ...
  local function _10_()
    local function _11_()
      ...
      local get_workspace_dir = config["get-workspace-dir"]
      local result = get_workspace_dir()
  ...
  local function _13_()
    local function _14_()
      ...
      local get_stories_dir = config["get-stories-dir"]
      local result = get_stories_dir()
  ...
  local function _15_()
    local function _16_()
      ...
      local get_epics_dir = config["get-epics-dir"]
      local result = get_epics_dir()
  ...
  local function _17_()
    local function _18_()
      ...
      local is_configured = config["is-configured"]
      return assert.is_true(is_configured())
    end
    it("returns true when token is set", _18_)
    local function _19_()
      config.setup({})
      local is_configured = config["is-configured"]
      local result = is_configured()
