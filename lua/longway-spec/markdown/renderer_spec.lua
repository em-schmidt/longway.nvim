-- [nfnl] fnl/longway-spec/markdown/renderer_spec.fnl
...
local function _1_()
  ...
  local function _3_()
    ...
    local function _12_()
      local story = t["make-story"]({comments = {t["make-parsed-comment"]({author = "John Doe"})}})
      local result = renderer["render-story"](story)
  ...
  return describe("render-epic", _19_)
end
