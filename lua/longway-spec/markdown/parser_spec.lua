...
local function _1_()
  ...
  local function _3_()
    local function _4_()
      ...
      local result = parser["extract-description"](content)
  ...
  local function _7_()
    local function _8_()
      ...
      local result = parser["extract-tasks"](content)
  ...
  local function _14_()
    local function _15_()
      ...
      local result = parser["extract-comments"](content)
      assert.equals(1, #result)
  ...
  local function _21_()
    local function _22_()
      local content = t["sample-markdown"]()
      local result = parser["get-shortcut-id"](content)
  ...
  local function _24_()
    local function _25_()
      local content = t["sample-markdown"]()
      return assert.is_true(parser["is-longway-file"](content))
    end
    it("returns true for longway files", _25_)
    local function _26_()
      local content = "# Regular File\n\nJust content."
      return assert.is_false(parser["is-longway-file"](content))
    end
