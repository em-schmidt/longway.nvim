...
local function _1_()
  ...
  local function _3_()
    local function _4_()
      ...
      local result = parser.extract_description(content)
  ...
  describe("extract_comments", _14_)
  local function _18_()
    local function _19_()
  ...
  local function _21_()
    local function _22_()
      local content = t["sample-markdown"]()
      local result = parser.get_shortcut_id(content)
  ...
  describe("get_shortcut_id", _21_)
  local function _24_()
    local function _25_()
      local content = t["sample-markdown"]()
      return assert.is_true(parser.is_longway_file(content))
    end
    it("returns true for longway files", _25_)
    local function _26_()
      local content = "# Regular File\n\nJust content."
      return assert.is_false(parser.is_longway_file(content))
    end
    return it("returns false for regular markdown", _26_)
  end
  return describe("is_longway_file", _24_)
end
